...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while place is not None:
            if place.bees and place.is_hive == False and count >= self.lower_bound and count <= self.upper_bound:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        # 考虑少情况,我直接先减少自己的血量,如果自己死了,可能会导致下面无法获取属性
        # 导致:AttributeError: 'NoneType' object has no attribute 'bees'
        # 应该先获取属性,再减少自己的血量
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        "*** YOUR CODE HERE ***"
        return False if isinstance(other, ContainerAnt) or self.ant_contained != None else True
        # END Problem 8a

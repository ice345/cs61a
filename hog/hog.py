...
def boar_brawl(player_score, opponent_score):
    ...
    score = abs(player_digit - opponent_digit) * 3
    return max(1, score)
    # END PROBLEM 2
...
def sus_points(score):
    ...
    if(num_factors(score) == 4 or num_factors(score) == 3):
        indicator = score + 1
        while(is_prime(indicator) == False):
            indicator += 1
        score = indicator
    return score
    # END PROBLEM 4
...
def make_averaged(original_function, samples_count=1000):
    ...
    return func
    # return lambda *args: sum(original_function(*args) for _ in range(samples_count)) / samples_count
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    for num_rolls in range(1, 11):
        average_score = make_averaged(roll_dice, samples_count)(num_rolls, dice)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """*** YOUR CODE HERE ***"""
    temp = sus_update(0, score, opponent_score)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score == 0:
        return 6
    if score >= 90:
        if sus_strategy(score, opponent_score, 10, 6) == 0:
            return 0
        else:
            return 2
    if score >= 80:
        if boar_strategy(score, opponent_score, 9, 6) == 0:
            return 0
        else:
            return 3
    return 6

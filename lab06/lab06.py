class Transaction:
    ...
    def changed(self):
        ...
        "*** YOUR CODE HERE ***"
        return True if self.before != self.after and self.after >= 0 else False
    ...
    def report(self):
        ...
        if self.changed():
            ...
            if self.before > self.after and self.after >= 0:
...
class Account:
    ...
    def deposit(self, amount):
        ...
        """
        temp = Transaction(len(self.transactions), self.balance, self.balance + amount)
...
class Server:
    ...
    def send(self, email):
        ...
        for client in self.clients:
            if self.clients[client].name == email.recipient_name:
                self.clients[client].inbox.append(email)
